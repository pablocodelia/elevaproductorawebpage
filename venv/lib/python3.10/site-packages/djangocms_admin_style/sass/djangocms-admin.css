...
a.btn[disabled], a.btn[disabled]:hover, a.btn[disabled]:focus a.btn[disabled]:active {
  ...
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
  box-shadow: none !important;
}
a.btn[disabled]:before, a.btn[disabled]:hover:before, a.btn[disabled]:focus a.btn[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.cms-btn-group[disabled], .cms-btn-group[disabled]:hover, .cms-btn-group[disabled]:focus .cms-btn-group[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.cms-btn-group[disabled]:before, .cms-btn-group[disabled]:hover:before, .cms-btn-group[disabled]:focus .cms-btn-group[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.cms_btn-active[disabled], .cms_btn-active[disabled]:hover, .cms_btn-active[disabled]:focus .cms_btn-active[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.cms_btn-active[disabled]:before, .cms_btn-active[disabled]:hover:before, .cms_btn-active[disabled]:focus .cms_btn-active[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
ul.errorlist a, ul.errorlist a:link, ul.errorlist a:hover, ul.errorlist a:focus, ul.errorlist a:visited {
  color: #333333;
}
ul.errorlist li {
  color: #f00 !important;
...
.admin_shortcuts .shortcuts li a:before, .cms-icon {
  display: inline-block;
...
.related-lookup[disabled], .related-lookup[disabled]:hover, .related-lookup[disabled]:focus .related-lookup[disabled]:active {
...
.related-lookup[disabled]:before, .related-lookup[disabled]:hover:before, .related-lookup[disabled]:focus .related-lookup[disabled]:active:before {
...
.add-another[disabled], .add-another[disabled]:hover, .add-another[disabled]:focus .add-another[disabled]:active,
.add-related[disabled],
.add-related[disabled]:hover,
.add-another[disabled]:focus .add-related[disabled]:active,
.change-related[disabled],
.change-related[disabled]:hover,
.add-another[disabled]:focus .change-related[disabled]:active,
.delete-related[disabled],
.delete-related[disabled]:hover,
.add-another[disabled]:focus .delete-related[disabled]:active,
.add-related[disabled]:focus .add-another[disabled]:active,
.add-related[disabled]:focus .add-related[disabled]:active,
.add-related[disabled]:focus .change-related[disabled]:active,
.add-related[disabled]:focus .delete-related[disabled]:active,
.change-related[disabled]:focus .add-another[disabled]:active,
.change-related[disabled]:focus .add-related[disabled]:active,
.change-related[disabled]:focus .change-related[disabled]:active,
.change-related[disabled]:focus .delete-related[disabled]:active,
.delete-related[disabled]:focus .add-another[disabled]:active,
.delete-related[disabled]:focus .add-related[disabled]:active,
.delete-related[disabled]:focus .change-related[disabled]:active,
.delete-related[disabled]:focus .delete-related[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.add-another[disabled]:before, .add-another[disabled]:hover:before, .add-another[disabled]:focus .add-another[disabled]:active:before,
.add-related[disabled]:before,
.add-related[disabled]:hover:before,
.add-another[disabled]:focus .add-related[disabled]:active:before,
.change-related[disabled]:before,
.change-related[disabled]:hover:before,
.add-another[disabled]:focus .change-related[disabled]:active:before,
.delete-related[disabled]:before,
.delete-related[disabled]:hover:before,
.add-another[disabled]:focus .delete-related[disabled]:active:before,
.add-related[disabled]:focus .add-another[disabled]:active:before,
.add-related[disabled]:focus .add-related[disabled]:active:before,
.add-related[disabled]:focus .change-related[disabled]:active:before,
.add-related[disabled]:focus .delete-related[disabled]:active:before,
.change-related[disabled]:focus .add-another[disabled]:active:before,
.change-related[disabled]:focus .add-related[disabled]:active:before,
.change-related[disabled]:focus .change-related[disabled]:active:before,
.change-related[disabled]:focus .delete-related[disabled]:active:before,
.delete-related[disabled]:focus .add-another[disabled]:active:before,
.delete-related[disabled]:focus .add-related[disabled]:active:before,
.delete-related[disabled]:focus .change-related[disabled]:active:before,
.delete-related[disabled]:focus .delete-related[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
.add-another:before,
.add-related:before,
...
.cms_modal-window .object-tools {
  background-color: transparent;
}
.popup .object-tools:before,
.cms-admin-modal .object-tools:before,
.cms_modal-window .object-tools:before {
  display: none;
}
...
.popup.change-list #changelist.cms-pagetree-root #changelist-form,
.cms-admin-modal.change-list #changelist.cms-pagetree-root #changelist-form,
.cms_modal-window.change-list #changelist.cms-pagetree-root #changelist-form {
  float: none;
  width: 100% !important;
}
...
.popup #content, .popup.filebrowser #content,
...
.cms-admin-modal .form-row .fieldBox,
.cms_modal-window .form-row .fieldBox {
  float: left;
  margin-right: 20px !important;
  margin-top: 0;
}
.popup .form-row .fieldBox.field-registration_deadline_at,
.cms-admin-modal .form-row .fieldBox.field-registration_deadline_at,
.cms_modal-window .form-row .fieldBox.field-registration_deadline_at {
  margin-right: 0 !important;
}
...
.popup .bootstrap3-column .form-row .fieldBox label,
.cms-admin-modal .bootstrap3-column .form-row .fieldBox label,
.cms_modal-window .bootstrap3-column .form-row .fieldBox label {
  display: inline-block;
  float: left;
  width: 70px !important;
}
.popup .bootstrap3-column .form-row .fieldBox input,
.cms-admin-modal .bootstrap3-column .form-row .fieldBox input,
.cms_modal-window .bootstrap3-column .form-row .fieldBox input {
  width: auto !important;
}
.popup .bootstrap3-column .form-row .fieldBox input[type=number],
.cms-admin-modal .bootstrap3-column .form-row .fieldBox input[type=number],
.cms_modal-window .bootstrap3-column .form-row .fieldBox input[type=number] {
...
.cms-admin-modal.delete-confirmation .cancel-link,
.cms_modal-window.delete-confirmation .cancel-link {
  display: none;
}
...
.cms-admin-modal.change-list #changelist.cms-pagetree-root {
  margin-top: 40px;
}
...
.cms-admin-sideframe.cms-debug #container .breadcrumbs {
  padding-top: 16px !important;
}
.cms-admin-sideframe #content {
  margin-top: 117px !important;
}
.cms-admin-sideframe.cms-debug #content {
...
form .form-row:not(tr) .vManyToManyRawIdAdminField {
...
form .form-row .fieldBox:nth-of-type(1):nth-last-of-type(2) {
  width: 50%;
  box-sizing: border-box;
  margin: 0 !important;
  padding-right: 10px;
...
form .form-row .fieldBox:nth-of-type(2):nth-last-of-type(1) {
  width: 50%;
  box-sizing: border-box;
  margin: 0 !important;
  padding-left: 10px;
...
form button:-moz-ui-invalid,
form input[type=text]:-moz-ui-invalid,
form input[type=email]:-moz-ui-invalid,
form input[type=password]:-moz-ui-invalid,
form input[type=number]:-moz-ui-invalid,
form input[type=url]:-moz-ui-invalid,
form select:-moz-ui-invalid,
form textarea:-moz-ui-invalid {
  box-shadow: none;
}
form input.vDateField,
form input.vTimeField,
form .datetime input.vDateField,
form .datetime input.vTimeField,
form .form-row .datetime input.vDateField,
form .form-row .datetime input.vTimeField {
  width: calc(100% - 112px) !important;
  margin-left: 0;
  margin-bottom: 0;
}
form br + label,
form .datetime br + label,
form .form-row .datetime br + label {
  margin-top: 10px;
}
...
form .aligned label:not(.vCheckboxLabel):after {
  content: none;
}
...
form label.aligned + div.readonly {
  width: 160px;
  margin-left: 170px;
}
form input,
...
form .select2-container.select2-container--default .select2-selection--single .select2-selection__rendered .select2-selection__clear {
  line-height: 36px;
}
...
form .select2-container .select2-choice .select2-search-choice-close {
  top: 10px;
  right: 35px;
}
...
button[disabled]:before, button[disabled]:hover:before, button[disabled]:focus button[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
input[type=submit][disabled]:focus input[type=button][disabled]:active,
...
input[type=submit][disabled]:before, input[type=submit][disabled]:hover:before, input[type=submit][disabled]:focus input[type=submit][disabled]:active:before,
input[type=button][disabled]:before,
input[type=button][disabled]:hover:before,
input[type=submit][disabled]:focus input[type=button][disabled]:active:before,
input[type=button][disabled]:focus input[type=submit][disabled]:active:before,
input[type=button][disabled]:focus input[type=button][disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
input[type=submit].default[disabled], input[type=submit].default[disabled]:hover, input[type=submit].default[disabled]:focus input[type=submit].default[disabled]:active,
input[type=button].default[disabled],
input[type=button].default[disabled]:hover,
input[type=submit].default[disabled]:focus input[type=button].default[disabled]:active,
input[type=button].default[disabled]:focus input[type=submit].default[disabled]:active,
input[type=button].default[disabled]:focus input[type=button].default[disabled]:active {
  background-color: rgba(0, 187, 255, 0.4) !important;
  border-color: rgba(0, 187, 255, 0.4) !important;
  color: rgba(255, 255, 255, 0.8) true;
  cursor: not-allowed;
...
input[type=submit].default[disabled]:before, input[type=submit].default[disabled]:hover:before, input[type=submit].default[disabled]:focus input[type=submit].default[disabled]:active:before,
input[type=button].default[disabled]:before,
input[type=button].default[disabled]:hover:before,
input[type=submit].default[disabled]:focus input[type=button].default[disabled]:active:before,
input[type=button].default[disabled]:focus input[type=submit].default[disabled]:active:before,
input[type=button].default[disabled]:focus input[type=button].default[disabled]:active:before {
  color: rgba(255, 255, 255, 0.4) true;
}
...
a.button[disabled]:before, a.button[disabled]:hover:before, a.button[disabled]:focus a.button[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
a.button.tab {
  border-radius: 0;
...
span.datetimeshortcuts a[disabled], span.datetimeshortcuts a[disabled]:hover, span.datetimeshortcuts a[disabled]:focus span.datetimeshortcuts a[disabled]:active,
.calendar-shortcuts a[disabled],
.calendar-shortcuts a[disabled]:hover,
span.datetimeshortcuts a[disabled]:focus .calendar-shortcuts a[disabled]:active,
.calendar-shortcuts a[disabled]:focus span.datetimeshortcuts a[disabled]:active,
.calendar-shortcuts a[disabled]:focus .calendar-shortcuts a[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
span.datetimeshortcuts a[disabled]:before, span.datetimeshortcuts a[disabled]:hover:before, span.datetimeshortcuts a[disabled]:focus span.datetimeshortcuts a[disabled]:active:before,
.calendar-shortcuts a[disabled]:before,
.calendar-shortcuts a[disabled]:hover:before,
span.datetimeshortcuts a[disabled]:focus .calendar-shortcuts a[disabled]:active:before,
.calendar-shortcuts a[disabled]:focus span.datetimeshortcuts a[disabled]:active:before,
.calendar-shortcuts a[disabled]:focus .calendar-shortcuts a[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.calendar-shortcuts a:first-child {
  text-align: center;
  width: 40px;
  margin-right: 5px;
  margin-left: 5px;
...
.related-widget-wrapper.widget-wrapper-links-1 select {
  width: calc(100% - 46px) !important;
}
.related-widget-wrapper.widget-wrapper-links-2 select {
  width: calc(100% - 92px) !important;
}
.related-widget-wrapper.widget-wrapper-links-3 select {
...
.related-widget-wrapper select + .related-widget-wrapper-link,
.related-widget-wrapper .related-widget-wrapper-link + .related-widget-wrapper-link {
  margin: 0;
}
.related-widget-wrapper .related-widget-wrapper-link + .related-widget-wrapper-link + .related-widget-wrapper-link {
  margin-left: 5px;
  margin-right: 0;
}
...
.related-widget-wrapper a.change-related:last-child {
  margin-right: 0;
}
...
.dashboard table th a:not(.cke_button),
.dashboard table td p,
.dashboard table td a:not(.cke_button),
.change-list table th p,
.change-list table th a:not(.cke_button),
.change-list table td p,
.change-list table td a:not(.cke_button),
.tabular table th p,
.tabular table th a:not(.cke_button),
.tabular table td p,
.tabular table td a:not(.cke_button),
.results table th p,
.results table th a:not(.cke_button),
.results table td p,
.results table td a:not(.cke_button),
#change-history th p,
#change-history th a:not(.cke_button),
#change-history td p,
#change-history td a:not(.cke_button) {
  font-size: 14px !important;
  line-height: 14px;
  font-weight: normal;
  padding: 0;
...
.dashboard table th a:not(.cke_button).inlinechangelink,
.dashboard table td p.inlinechangelink,
.dashboard table td a:not(.cke_button).inlinechangelink,
.change-list table th p.inlinechangelink,
.change-list table th a:not(.cke_button).inlinechangelink,
.change-list table td p.inlinechangelink,
.change-list table td a:not(.cke_button).inlinechangelink,
.tabular table th p.inlinechangelink,
.tabular table th a:not(.cke_button).inlinechangelink,
.tabular table td p.inlinechangelink,
.tabular table td a:not(.cke_button).inlinechangelink,
.results table th p.inlinechangelink,
.results table th a:not(.cke_button).inlinechangelink,
.results table td p.inlinechangelink,
.results table td a:not(.cke_button).inlinechangelink,
#change-history th p.inlinechangelink,
#change-history th a:not(.cke_button).inlinechangelink,
#change-history td p.inlinechangelink,
#change-history td a:not(.cke_button).inlinechangelink {
  font: 0/0 a !important;
  padding-left: 12px;
}
.dashboard table th p.inlinechangelink:before,
.dashboard table th a:not(.cke_button).inlinechangelink:before,
.dashboard table td p.inlinechangelink:before,
.dashboard table td a:not(.cke_button).inlinechangelink:before,
.change-list table th p.inlinechangelink:before,
.change-list table th a:not(.cke_button).inlinechangelink:before,
.change-list table td p.inlinechangelink:before,
.change-list table td a:not(.cke_button).inlinechangelink:before,
.tabular table th p.inlinechangelink:before,
.tabular table th a:not(.cke_button).inlinechangelink:before,
.tabular table td p.inlinechangelink:before,
.tabular table td a:not(.cke_button).inlinechangelink:before,
.results table th p.inlinechangelink:before,
.results table th a:not(.cke_button).inlinechangelink:before,
.results table td p.inlinechangelink:before,
.results table td a:not(.cke_button).inlinechangelink:before,
#change-history th p.inlinechangelink:before,
#change-history th a:not(.cke_button).inlinechangelink:before,
#change-history td p.inlinechangelink:before,
#change-history td a:not(.cke_button).inlinechangelink:before {
  font-size: 16px;
  vertical-align: top;
  margin: 0;
}
.dashboard table th p.lang-code,
.dashboard table th a:not(.cke_button).lang-code,
.dashboard table td p.lang-code,
.dashboard table td a:not(.cke_button).lang-code,
.change-list table th p.lang-code,
.change-list table th a:not(.cke_button).lang-code,
.change-list table td p.lang-code,
.change-list table td a:not(.cke_button).lang-code,
.tabular table th p.lang-code,
.tabular table th a:not(.cke_button).lang-code,
.tabular table td p.lang-code,
.tabular table td a:not(.cke_button).lang-code,
.results table th p.lang-code,
.results table th a:not(.cke_button).lang-code,
.results table td p.lang-code,
.results table td a:not(.cke_button).lang-code,
#change-history th p.lang-code,
#change-history th a:not(.cke_button).lang-code,
#change-history td p.lang-code,
#change-history td a:not(.cke_button).lang-code {
  font-size: 12px !important;
}
.dashboard table th p,
.dashboard table td p,
...
.dashboard table td .related-widget-wrapper select,
.change-list table td .related-widget-wrapper select,
.tabular table td .related-widget-wrapper select,
.results table td .related-widget-wrapper select,
#change-history td .related-widget-wrapper select {
  float: none;
  vertical-align: top;
  width: auto !important;
}
...
.dashboard table.ui-sortable thead th:first-child,
.change-list table.ui-sortable thead th:first-child,
.tabular table.ui-sortable thead th:first-child,
.results table.ui-sortable thead th:first-child,
#change-history.ui-sortable thead th:first-child {
  font: 0/0 a;
}
...
.dashboard table.ui-sortable .action-checkbox,
.change-list table.ui-sortable .action-checkbox,
.tabular table.ui-sortable .action-checkbox,
.results table.ui-sortable .action-checkbox,
#change-history.ui-sortable .action-checkbox {
  padding: 0 15px !important;
}
.dashboard table.ui-sortable .ui-sortable-placeholder td,
.change-list table.ui-sortable .ui-sortable-placeholder td,
.tabular table.ui-sortable .ui-sortable-placeholder td,
.results table.ui-sortable .ui-sortable-placeholder td,
#change-history.ui-sortable .ui-sortable-placeholder td {
  height: 38px;
}
...
.tabular table tbody tr.has_original td {
  padding-top: 36px !important;
}
.tabular table th.original,
.tabular table td.original {
  padding-left: 0 !important;
  padding-right: 0 !important;
  padding-top: 0 !important;
}
.tabular table th.original p,
...
.tabular table td.original .vManyToManyRawIdAdminField {
  width: auto;
}
.tabular table tbody tr.has_original td.original {
  padding-top: 0 !important;
  position: relative;
}
...
.tabular table .related-widget-wrapper a.change-related {
  margin-left: 10px;
}
...
.change-list table.navigator-table tbody td {
  vertical-align: middle !important;
}
...
.change-list .results #result_list .related-widget-wrapper a.change-related {
  margin-right: 0;
  margin-left: 5px;
}
...
.change-list #changelist #action-toggle {
  vertical-align: middle;
}
...
.change-list #changelist.filtered .changelist-form-container {
  position: relative;
  display: inline-block;
  width: calc(100% - 278px) !important;
}
.change-list #changelist.filtered .changelist-form-container .results + .paginator {
  box-sizing: border-box;
  width: 100% !important;
}
...
.change-list #changelist-search input[type=submit][disabled], .change-list #changelist-search input[type=submit][disabled]:hover, .change-list #changelist-search input[type=submit][disabled]:focus .change-list #changelist-search input[type=submit][disabled]:active {
  background-color: rgba(0, 187, 255, 0.4) !important;
  border-color: rgba(0, 187, 255, 0.4) !important;
  color: rgba(255, 255, 255, 0.8) true;
  cursor: not-allowed;
...
.change-list #changelist-search input[type=submit][disabled]:before, .change-list #changelist-search input[type=submit][disabled]:hover:before, .change-list #changelist-search input[type=submit][disabled]:focus .change-list #changelist-search input[type=submit][disabled]:active:before {
  color: rgba(255, 255, 255, 0.4) true;
}
.change-list #changelist-search input[type=submit]:active {
  background-image: url("../img/icon_search_white@2x.png") !important;
...
.djangocms-admin-style table {
  margin-bottom: 0 !important;
}
.djangocms-admin-style thead th {
  font-size: 14px;
  text-transform: uppercase;
  border-color: #dddddd;
  background-color: #fff;
...
.djangocms-admin-style thead th.sorted {
  background-color: #fff;
}
.djangocms-admin-style thead th.action-checkbox-column {
  padding: 0 15px !important;
}
.djangocms-admin-style thead th .text {
  float: none;
  padding-right: 0;
}
.djangocms-admin-style thead th .text a {
  padding: 0 !important;
}
.djangocms-admin-style thead th .sortoptions {
  display: inline-block;
  float: right;
  padding-top: 0;
}
.djangocms-admin-style thead th .sortoptions a.sortremove:after {
  display: none;
}
...
.djangocms-admin-style .inline-group h2,
.djangocms-admin-style .inline-group h3,
.djangocms-admin-style .inline-group h4,
.djangocms-admin-style .inline-group h5,
.djangocms-admin-style .inline-group h6 {
  margin-top: 0;
  margin-bottom: 12px;
}
.djangocms-admin-style .inline-group .module {
  padding: 0;
...
.djangocms-admin-style .inline-group .module h2 {
  font-size: 16px !important;
  margin-bottom: 10px;
  padding-top: 0;
}
.djangocms-admin-style .inline-group .module .add-row a {
  color: #693;
  border-bottom: none;
}
.djangocms-admin-style .inline-group .module .add-row a:before {
  color: #693;
}
.djangocms-admin-style .inline-group .module .add-row a:hover {
  color: #5da03d !important;
}
.djangocms-admin-style .inline-group .module .add-row td {
  padding: 10px 0 !important;
  border-bottom: solid 1px #dddddd !important;
  background: none;
}
.djangocms-admin-style .inline-group .module tr.add-row:hover {
  background: none;
}
.djangocms-admin-style .inline-group .module .form-row {
  border-bottom: none !important;
}
.djangocms-admin-style .inline-group .add-row {
  border-bottom: 0 !important;
}
.djangocms-admin-style .inline-group .add-row,
.djangocms-admin-style .inline-group .add-row td {
  border-bottom: none;
  background: none !important;
}
.djangocms-admin-style .inline-group .add-row a {
  color: #693;
  font-size: 14px !important;
  padding-left: 0 !important;
  background: none !important;
}
.djangocms-admin-style .inline-group .add-row a:before {
  color: #693;
}
...
.inline-group[data-inline-type=stacked] .inline-related h3 b,
.inline-group[data-inline-type=stacked] .inline-related h3 span {
  font-size: 16px;
}
.inline-group[data-inline-type=stacked] .inline-related h3 span {
  color: #000;
}
.inline-group[data-inline-type=stacked] .inline-related fieldset.module {
  padding: 20px 25px !important;
}
.inline-group[data-inline-type=stacked] .inline-related input.vTextField,
.inline-group[data-inline-type=stacked] .inline-related input.vURLField,
.inline-group[data-inline-type=stacked] .inline-related textarea.vLargeTextField,
.inline-group[data-inline-type=stacked] .inline-related .selector .selector-filter input {
  width: 100% !important;
}
.inline-group[data-inline-type=stacked] .inline-related .selector .selector-available h2,
.inline-group[data-inline-type=stacked] .inline-related .selector .selector-chosen h2 {
  font-size: 14px !important;
  padding-top: 10px;
}
...
.djangocms-admin-style .submit-row .deletelink-box {
  margin: 0;
}
.djangocms-admin-style .submit-row .deletelink-box .deletelink {
  background-image: none !important;
  margin-bottom: 0;
  padding: 6px 20px !important;
  border-radius: 3px !important;
...
.djangocms-admin-style .submit-row .deletelink-box .deletelink:focus {
  color: #454545 !important;
  background-color: #f2f2f2 !important;
  border-color: #d0d0d0 !important;
  text-decoration: none !important;
}
.djangocms-admin-style .submit-row .deletelink-box .deletelink:hover {
  color: #454545 !important;
  background-color: #f2f2f2 !important;
  border-color: #d0d0d0 !important;
  text-decoration: none !important;
}
.djangocms-admin-style .submit-row .deletelink-box .deletelink:active {
  color: #454545 !important;
  background-color: #e6e6e6 !important;
  border-color: #c3c3c3 !important;
  box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125) !important;
}
.djangocms-admin-style .submit-row .deletelink-box .deletelink:active:hover, .djangocms-admin-style .submit-row .deletelink-box .deletelink:active:focus {
  color: #454545 !important;
  background-color: #d4d4d4 !important;
  border-color: #9d9d9d !important;
}
...
.djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled], .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:hover, .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:focus .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:before, .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:hover:before, .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:focus .djangocms-admin-style .submit-row .deletelink-box .deletelink[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
.djangocms-admin-style .submit-row .deletelink-box .deletelink:before {
  content: "\E044";
}
.djangocms-admin-style .submit-row input[type=submit] {
  padding: 10px 20px !important;
  height: 36px;
}
.djangocms-admin-style .submit-row input[type=submit].default {
  margin-left: 10px;
  padding: 10px 20px !important;
}
.djangocms-admin-style .submit-row input {
  width: auto !important;
  height: 36px;
  margin-left: 10px;
}
...
#content-main .object-tools .addlink[disabled], #content-main .object-tools .addlink[disabled]:hover, #content-main .object-tools .addlink[disabled]:focus #content-main .object-tools .addlink[disabled]:active {
  background-color: rgba(0, 187, 255, 0.4) !important;
  border-color: rgba(0, 187, 255, 0.4) !important;
  color: rgba(255, 255, 255, 0.8) true;
  cursor: not-allowed;
...
#content-main .object-tools .addlink[disabled]:before, #content-main .object-tools .addlink[disabled]:hover:before, #content-main .object-tools .addlink[disabled]:focus #content-main .object-tools .addlink[disabled]:active:before {
  color: rgba(255, 255, 255, 0.4) true;
}
...
.object-tools li > a[disabled], .object-tools li > a[disabled]:hover, .object-tools li > a[disabled]:focus .object-tools li > a[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.object-tools li > a[disabled]:before, .object-tools li > a[disabled]:hover:before, .object-tools li > a[disabled]:focus .object-tools li > a[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.object-tools .addlink[disabled], .object-tools .addlink[disabled]:hover, .object-tools .addlink[disabled]:focus .object-tools .addlink[disabled]:active {
  background-color: rgba(0, 187, 255, 0.4) !important;
  border-color: rgba(0, 187, 255, 0.4) !important;
  color: rgba(255, 255, 255, 0.8) true;
  cursor: not-allowed;
...
.object-tools .addlink[disabled]:before, .object-tools .addlink[disabled]:hover:before, .object-tools .addlink[disabled]:focus .object-tools .addlink[disabled]:active:before {
  color: rgba(255, 255, 255, 0.4) true;
}
...
.object-tools .publishlink[disabled], .object-tools .publishlink[disabled]:hover, .object-tools .publishlink[disabled]:focus .object-tools .publishlink[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.object-tools .publishlink[disabled]:before, .object-tools .publishlink[disabled]:hover:before, .object-tools .publishlink[disabled]:focus .object-tools .publishlink[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.object-tools .previewdraftlink[disabled], .object-tools .previewdraftlink[disabled]:hover, .object-tools .previewdraftlink[disabled]:focus .object-tools .previewdraftlink[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.object-tools .previewdraftlink[disabled]:before, .object-tools .previewdraftlink[disabled]:hover:before, .object-tools .previewdraftlink[disabled]:focus .object-tools .previewdraftlink[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.object-tools .revertlink[disabled], .object-tools .revertlink[disabled]:hover, .object-tools .revertlink[disabled]:focus .object-tools .revertlink[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.object-tools .revertlink[disabled]:before, .object-tools .revertlink[disabled]:hover:before, .object-tools .revertlink[disabled]:focus .object-tools .revertlink[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.object-tools .historylink[disabled], .object-tools .historylink[disabled]:hover, .object-tools .historylink[disabled]:focus .object-tools .historylink[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.object-tools .historylink[disabled]:before, .object-tools .historylink[disabled]:hover:before, .object-tools .historylink[disabled]:focus .object-tools .historylink[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.object-tools .viewsitelink[disabled], .object-tools .viewsitelink[disabled]:hover, .object-tools .viewsitelink[disabled]:focus .object-tools .viewsitelink[disabled]:active {
  background-color: rgba(0, 187, 255, 0.4) !important;
  border-color: rgba(0, 187, 255, 0.4) !important;
  color: rgba(255, 255, 255, 0.8) true;
  cursor: not-allowed;
...
.object-tools .viewsitelink[disabled]:before, .object-tools .viewsitelink[disabled]:hover:before, .object-tools .viewsitelink[disabled]:focus .object-tools .viewsitelink[disabled]:active:before {
  color: rgba(255, 255, 255, 0.4) true;
}
...
.delete-confirmation .colM input[type=submit][disabled], .delete-confirmation .colM input[type=submit][disabled]:hover, .delete-confirmation .colM input[type=submit][disabled]:focus .delete-confirmation .colM input[type=submit][disabled]:active {
  background-color: rgba(0, 187, 255, 0.4) !important;
  border-color: rgba(0, 187, 255, 0.4) !important;
  color: rgba(255, 255, 255, 0.8) true;
  cursor: not-allowed;
...
.delete-confirmation .colM input[type=submit][disabled]:before, .delete-confirmation .colM input[type=submit][disabled]:hover:before, .delete-confirmation .colM input[type=submit][disabled]:focus .delete-confirmation .colM input[type=submit][disabled]:active:before {
  color: rgba(255, 255, 255, 0.4) true;
}
...
.djangocms-admin-style #page_form_lang_tabs,
.djangocms-admin-style .parler-language-tabs {
  margin-bottom: 30px;
  border-bottom: solid 1px #dddddd;
}
...
.dashboard #container #content-main table caption {
  letter-spacing: 0;
}
...
body.login.djangocms-admin-style #container #content #content-main .submit-row input:active:hover, body.login.djangocms-admin-style #container #content #content-main .submit-row input:active:focus,
...
body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled], body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:hover, body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:focus body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:active,
...
body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:focus body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:active,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:focus body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:active,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:focus body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:active {
  background-color: rgba(0, 187, 255, 0.4) !important;
  border-color: rgba(0, 187, 255, 0.4) !important;
  color: rgba(255, 255, 255, 0.8) true;
  cursor: not-allowed;
...
body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:before, body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:hover:before, body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:focus body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:active:before,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:before,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:hover:before,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:focus body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:active:before,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:focus body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:active:before,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:focus body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:active:before {
  color: rgba(255, 255, 255, 0.4) true;
}
...
.filebrowser #id_new_folder[disabled], .filebrowser #id_new_folder[disabled]:hover, .filebrowser #id_new_folder[disabled]:focus .filebrowser #id_new_folder[disabled]:active {
  background-color: rgba(255, 255, 255, 0.4) !important;
  border-color: rgba(221, 221, 221, 0.4) !important;
  color: rgba(69, 69, 69, 0.8) true;
  cursor: not-allowed;
...
.filebrowser #id_new_folder[disabled]:before, .filebrowser #id_new_folder[disabled]:hover:before, .filebrowser #id_new_folder[disabled]:focus .filebrowser #id_new_folder[disabled]:active:before {
  color: rgba(69, 69, 69, 0.4) true;
}
...
.filebrowser #toolbartable td:nth-child(1),
.filebrowser #toolbartable th:nth-child(1) {
  width: 20px;
}
.filebrowser #toolbartable td:nth-child(2),
.filebrowser #toolbartable th:nth-child(2) {
  width: 50px;
}
...
.filerFile .related-lookup[disabled], .filerFile .related-lookup[disabled]:hover, .filerFile .related-lookup[disabled]:focus .filerFile .related-lookup[disabled]:active,
...
.filerFile .related-lookup[disabled]:before, .filerFile .related-lookup[disabled]:hover:before, .filerFile .related-lookup[disabled]:focus .filerFile .related-lookup[disabled]:active:before,
...
.djn-tabular .tabular .module .inline-group .module h2 {
  padding-top: 10px;
}
.djn-tabular .tabular .module .djn-items {
  border-left: 5px solid #dddddd !important;
  margin-left: 0;
}
.djn-tabular .tabular .module .djn-tr td {
  vertical-align: top !important;
  width: auto !important;
  padding: 46px 0 0 7px !important;
}
.djn-tabular .tabular .module .djn-tr td.original {
  padding-top: 0 !important;
}
.djn-tabular .tabular .module .djn-tr td .datetimeshortcuts {
  margin-left: 10px;
}
.djn-tabular .tabular .module .djn-tr td .datetimeshortcuts a {
  margin-right: 5px;
}
.djn-tabular .tabular .module .djn-tr td .datetimeshortcuts a:before {
  line-height: 0;
}
...
.djangocms-admin-style .main .toggle-nav-sidebar {
  border-radius: 0 !important;
}
.djangocms-admin-style .main #nav-sidebar .module caption {
  padding-left: 0;
  background: #00bbff;
  margin: 0;
  padding: 10px;
...
.djangocms-admin-style .main #nav-sidebar .module caption a {
  color: #fff;
}
.djangocms-admin-style .main #nav-sidebar .module caption a:hover, .djangocms-admin-style .main #nav-sidebar .module caption a:active, .djangocms-admin-style .main #nav-sidebar .module caption a:focus {
  color: #fff !important;
}
.djangocms-admin-style .main #nav-sidebar th a {
  color: #333333;
}
.djangocms-admin-style .main #nav-sidebar th a,
.djangocms-admin-style .main #nav-sidebar td a {
  font-family: "Helvetica Neue", "Helvetica", "Arial", sans-serif;
  font-size: 14px !important;
  line-height: 14px !important;
  font-weight: normal;
...
.djangocms-admin-style .main #nav-sidebar table {
  box-shadow: 0 0 5px 0 rgba(0, 0, 0, 0.2);
}
...
@media only screen and (max-width: 768px) and (max-width: 500px), print and (max-width: 500px) {
  #branding #site-name {
    display: none;
  }
}
...
@media only screen and (max-width: 768px) and (max-width: 600px), print and (max-width: 600px) {
  .object-tools {
    float: left;
    max-width: 100% !important;
  }
...
@media only screen and (max-width: 768px), print {
  ...
  .cms-admin-sideframe.change-list #changelist .paginator, .cms-admin-sideframe.change-list #changelist.filtered .paginator, .cms-admin-sideframe.change-form #changelist .paginator, .cms-admin-sideframe.change-form #changelist.filtered .paginator {
  ...
  .cms-admin-modal.change-form #changelist .paginator, .cms-admin-modal.change-form #changelist.filtered .paginator, .cms-admin-modal.change-list #changelist .paginator, .cms-admin-modal.change-list #changelist.filtered .paginator,
...
}/*# sourceMappingURL=djangocms-admin.css.map */